...
echo ""
echo "============================================================"
echo "  Codex install (optional host)"
echo "============================================================"
echo ""
step "1. Add this repository as a Codex marketplace (repo root, so core/ is included):"
echo ""
echo "   The marketplace source is \".\" — not plugins/devflow/ alone."
echo "   That keeps core/orchestrator (delivery.py, artifact_publish.py) available."
echo ""
echo "   See adapters/codex/README.md for host-specific plugin add commands."
echo ""
echo "   After install, Codex can run init / start / status / next against"
echo "   core/orchestrator/SKILL.md plus the scripts under core/orchestrator/."
echo ""
echo "============================================================"
echo ""
